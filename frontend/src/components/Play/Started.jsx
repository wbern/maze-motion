...
export class Started extends React.Component {
    ...
    updateTimerRef() {
        if (this.timerElement) {
            let tempTime = Date.now() - this.state.status.startTime;
    ...
    render() {
        return (
            <div className="Started">
                ...
                <small>Current Section: {this.state.status.currentSection}</small>
                <small>Highest Section: {this.state.status.highestSection}</small>
